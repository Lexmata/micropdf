#!/usr/bin/env python3
"""
NanoPDF Python Benchmark Suite
...
def run_benchmarks() -> None:
    ...
    print("\n")
    print("╔════════════════════════════════════════════════════════════════════════════╗")
    print("║                    NanoPDF Python Benchmark Suite                          ║")
    print("╚════════════════════════════════════════════════════════════════════════════╝")
    print()
    ...
    # Import modules
    try:
        from nanopdf.geometry import Point, Rect, IRect, Matrix, Quad
    except ImportError:
        print("\nError: nanopdf not installed. Using pure Python geometry classes.")
    ...
    # ========================================================================
    try:
        from nanopdf.context import Context
        from nanopdf.buffer import Buffer
