...
MicroPDF for Bun supports automatic resource cleanup using the `using` keyword (TC39 Explicit Resource Management):
...
MicroPDF for Bun provides exceptional performance through:
