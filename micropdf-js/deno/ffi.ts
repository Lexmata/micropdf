/**
 * Deno FFI bindings for MicroPDF
 *
...
function findLibrary(): string {
  const possiblePaths = [
    ...
    `../../../micropdf-rs/target/release/${LIBRARY_PREFIX}micropdf${LIBRARY_EXTENSION}`,
    `../../../micropdf-rs/target/debug/${LIBRARY_PREFIX}micropdf${LIBRARY_EXTENSION}`,
    // System paths
  ...
  throw new Error(
    'Could not find libmicropdf library. ' +
      'Please build the Rust library first: cd micropdf-rs && cargo build --release'
  );
}
