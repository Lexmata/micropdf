...
import { MicroPDFError, type BufferLike, isBufferLike } from './types.js';
...
export class BufferReader {
   ...
   */
  readUInt16BE(): number {
    if (this.remaining < 2) throw MicroPDFError.eof();
   ...
   */
  readUInt32BE(): number {
    if (this.remaining < 4) throw MicroPDFError.eof();
   ...
   */
  readUInt24BE(): number {
    if (this.remaining < 3) throw MicroPDFError.eof();
