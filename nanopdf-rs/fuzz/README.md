...
Fuzzing tests for NanoPDF using [cargo-fuzz](https://github.com/rust-fuzz/cargo-fuzz) (libFuzzer).
...
NanoPDF can be integrated with [OSS-Fuzz](https://github.com/google/oss-fuzz) for continuous, large-scale fuzzing.
