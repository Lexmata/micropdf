...
#[unsafe(no_mangle)]
pub extern "C" fn fz_string_is_normalized(
    _ctx: Handle,
    input: *const c_char,
    form: i32,
) -> i32 {
    ...
    let has_ligatures = input_str.chars().any(|c| matches!(c, 'ﬁ' | 'ﬂ' | 'ﬀ' | 'ﬃ' | 'ﬄ'));
...
#[unsafe(no_mangle)]
pub extern "C" fn fz_char_to_byte_offset(
    _ctx: Handle,
    s: *const c_char,
    char_index: usize,
) -> i32 {
...
mod tests {
    ...
    fn test_bidi_detection() {
        ...
        assert_eq!(fz_get_bidi_direction(0, ltr.as_ptr()), BiDiDirection::LTR as i32);
        assert_eq!(fz_get_bidi_direction(0, rtl.as_ptr()), BiDiDirection::RTL as i32);
    }
    ...
    fn test_script_detection() {
        ...
        assert_eq!(fz_detect_script(0, latin.as_ptr()), ScriptCategory::Latin as i32);
        assert_eq!(fz_detect_script(0, arabic.as_ptr()), ScriptCategory::Arabic as i32);
        assert_eq!(fz_detect_script(0, cjk.as_ptr()), ScriptCategory::CJK as i32);
    }
