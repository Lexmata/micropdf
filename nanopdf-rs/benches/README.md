...
Comprehensive performance benchmarks for all core nanopdf features.
...
**🔗 [View Live Benchmarks](https://lexmata.github.io/nanopdf/dev/bench/)**
...
```
nanopdf-rs/target/criterion/report/index.html
```
...
use nanopdf::fitz::my_feature::MyFeature;
