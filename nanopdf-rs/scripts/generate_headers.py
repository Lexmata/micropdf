...
def generate_module_header(module_name: str, functions: List[Dict], is_pdf: bool = False) -> str:
    ...
    header = f"""// NanoPDF - MuPDF API Compatible C Header
...
def generate_master_headers(include_dir: Path, all_modules: List[str], fitz_modules: set, pdf_modules: set):
    ...
    # Generate fitz.h
    fitz_header = """// NanoPDF - MuPDF API Compatible C Header
...
"""
    ...
    # Generate pdf.h
    pdf_header = """// NanoPDF - MuPDF API Compatible C Header
...
"""
    ...
    # Generate mupdf.h
    mupdf_header = """// NanoPDF - MuPDF API Compatible C Header
