...
// ============================================================================
// Annot Functions (25 total)
// ============================================================================

void pdf_annot_author(int32_t _ctx, int32_t annot, char * buf, int size);
void pdf_annot_clear_dirty(int32_t _ctx, int32_t annot);
void pdf_annot_contents(int32_t _ctx, int32_t annot, char * buf, int size);
c_uint pdf_annot_flags(int32_t _ctx, int32_t annot);
int pdf_annot_has_dirty(int32_t _ctx, int32_t annot);
int32_t pdf_annot_has_popup(int32_t _ctx, int32_t annot);
int32_t pdf_annot_is_valid(int32_t _ctx, int32_t annot);
int pdf_annot_is_valid(int32_t _ctx, int32_t annot);
...
int pdf_annot_type(int32_t _ctx, int32_t annot);
int32_t pdf_clone_annot(int32_t _ctx, int32_t annot);
int32_t pdf_create_annot(int32_t _ctx, int32_t _page, int annot_type);
...
void pdf_set_annot_author(int32_t _ctx, int32_t annot, const char * author);
void pdf_set_annot_contents(int32_t _ctx, int32_t annot, const char * text);
void pdf_set_annot_flags(int32_t _ctx, int32_t annot, c_uint flags);
...
int pdf_update_annot(int32_t _ctx, int32_t annot);
