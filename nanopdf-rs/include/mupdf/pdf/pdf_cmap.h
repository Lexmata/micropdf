...
int32_t pdf_decode_cmap(int32_t cmap, const u8 * s, const u8 * e, uint32_t * cpt);
...
void pdf_map_one_to_many(int32_t _ctx, int32_t cmap, uint32_t one, const int32_t * many, size_t len);
