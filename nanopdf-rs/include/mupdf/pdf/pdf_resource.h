...
void pdf_eval_function(int32_t _ctx, int32_t func, const float * input, int32_t inlen, float * output, int32_t outlen);
...
void * pdf_find_item(int32_t _ctx, const void * _drop, int32_t _key);
size_t pdf_function_size(int32_t _ctx, int32_t func);
int32_t pdf_guess_colorspace_components(int32_t _ctx, int32_t _obj);
int32_t pdf_insert_colorspace_resource(int32_t _ctx, int32_t doc, const ColorspaceResourceKey * key, int32_t obj);
int32_t pdf_insert_font_resource(int32_t _ctx, int32_t doc, const FontResourceKey * key, int32_t obj);
...
int32_t pdf_new_xobject(int32_t _ctx, int32_t _doc, const float * _bbox, const float * _matrix, int32_t _res, int32_t _buffer);
...
void pdf_remove_item(int32_t _ctx, const void * _drop, int32_t _key);
void pdf_sample_shade_function(int32_t _ctx, float * samples, int32_t n, int32_t funcs, const Handle * func_handles, float t0, float t1);
void pdf_store_item(int32_t _ctx, int32_t _key, void * _val, size_t _itemsize);
void pdf_update_xobject(int32_t _ctx, int32_t _doc, int32_t _xobj, const float * _bbox, const float * _matrix, int32_t _res, int32_t _buffer);
