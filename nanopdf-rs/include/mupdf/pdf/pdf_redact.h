...
void pdf_add_redact_annot_quad(int32_t _ctx, int32_t _annot, const float * _quad, x0 // 8 floats);
...
int32_t pdf_apply_all_redactions(int32_t _ctx, int32_t _doc, const RedactOptions * _opts);
int32_t pdf_apply_redaction(int32_t _ctx, int32_t _annot, const RedactOptions * _opts);
...
int32_t pdf_redact_document(int32_t _ctx, int32_t _doc, const RedactOptions * _opts);
int32_t pdf_redact_page_annotations(int32_t _ctx, int32_t _doc, int32_t _page, const RedactOptions * _opts);
