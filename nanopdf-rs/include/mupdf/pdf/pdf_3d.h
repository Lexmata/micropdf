...
const u8 * pdf_3d_get_data(int32_t _ctx, int32_t annot, size_t * len_out);
...
int32_t pdf_3d_set_prc_data(int32_t _ctx, int32_t annot, const u8 * data, size_t len);
int32_t pdf_3d_set_toolbar(int32_t _ctx, int32_t annot, int32_t show);
int32_t pdf_3d_set_u3d_data(int32_t _ctx, int32_t annot, const u8 * data, size_t len);
int32_t pdf_3d_set_view_background(int32_t _ctx, int32_t annot, int32_t view_index, float r, float g, float b, float a);
int32_t pdf_3d_set_view_camera(int32_t _ctx, int32_t annot, int32_t view_index, const Camera3D * camera);
