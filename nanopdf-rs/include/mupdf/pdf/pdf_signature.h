...
void pdf_pkcs7_verifier_add_cert(int32_t _ctx, int32_t verifier, const u8 * cert, size_t len);
...
size_t pdf_signature_contents(int32_t _ctx, int32_t doc, int32_t _signature, *mut c_char * contents);
