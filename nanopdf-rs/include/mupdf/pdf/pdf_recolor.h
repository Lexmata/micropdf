...
void pdf_convert_color(int32_t _ctx, int32_t _src_cs, const float * src, int32_t src_n, int32_t _dst_cs, float * dst, int32_t dst_n);
...
RecolorStats pdf_recolor_document(int32_t _ctx, int32_t _doc, const RecolorOptions * _opts);
RecolorOptions pdf_recolor_options_cmyk(void);
RecolorOptions pdf_recolor_options_gray(void);
int32_t pdf_recolor_options_is_valid(const RecolorOptions * opts);
RecolorOptions pdf_recolor_options_new(int32_t num_comp);
RecolorOptions pdf_recolor_options_rgb(void);
void pdf_recolor_page(int32_t _ctx, int32_t _doc, int32_t _pagenum, const RecolorOptions * _opts);
RecolorStats pdf_recolor_pages(int32_t _ctx, int32_t _doc, int32_t _start_page, int32_t _end_page, const RecolorOptions * _opts);
