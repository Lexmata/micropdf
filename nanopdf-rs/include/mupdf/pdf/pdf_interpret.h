...
void pdf_op_SC_color(int32_t _ctx, int32_t proc, int32_t n, const float * color);
...
void pdf_op_cs(int32_t _ctx, int32_t proc, const char * name);
void pdf_op_d(int32_t _ctx, int32_t proc, const float * array, int32_t array_len, float phase);
...
void pdf_process_contents(int32_t _ctx, int32_t proc, int32_t _doc, int32_t res, int32_t _stm, Handle * _out_res);
