...
int32_t pdf_access_launch_url_event(int32_t _ctx, int32_t handler, int32_t index, *mut c_char * url_out, int32_t * new_frame_out);
int32_t pdf_alert_get_button_pressed(const AlertEvent * evt);
...
void pdf_event_issue_alert(int32_t _ctx, int32_t handler, const AlertEvent * evt);
...
void pdf_event_issue_mail_doc(int32_t _ctx, int32_t handler, const MailDocEvent * evt);
