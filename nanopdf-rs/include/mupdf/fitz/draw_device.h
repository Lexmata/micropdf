...
void fz_draw_device_begin_mask(int32_t _ctx, int32_t device, const float * _mask_area, int32_t _luminosity);
void fz_draw_device_begin_path(int32_t _ctx, int32_t device);
void fz_draw_device_begin_pattern(int32_t _ctx, int32_t device, int32_t _pattern_handle, const float * _area);
...
void fz_draw_device_concat_ctm(int32_t _ctx, int32_t device, const float * matrix);
...
void fz_draw_device_set_ctm(int32_t _ctx, int32_t device, const float * matrix);
void fz_draw_device_set_dash(int32_t _ctx, int32_t device, const float * dash_array, int32_t dash_count, float dash_phase);
...
int32_t fz_new_draw_device_with_matrix(int32_t _ctx, int32_t target_pixmap, const float * matrix);
