...
int32_t fz_store_find(int32_t _ctx, const u8 * key, size_t key_len);
...
uint64_t fz_store_item(int32_t _ctx, int32_t item_type, int32_t handle, size_t size, const u8 * key, size_t key_len);
...
int32_t fz_store_remove_by_key(int32_t _ctx, const u8 * key, size_t key_len);
