...
void fz_write_base64(int32_t _ctx, int32_t out, const u8 * data, size_t size, int32_t newline);
void fz_write_base64_uri(int32_t _ctx, int32_t out, const u8 * data, size_t size);
...
void fz_write_data(int32_t _ctx, int32_t out, const void * data, size_t size);
