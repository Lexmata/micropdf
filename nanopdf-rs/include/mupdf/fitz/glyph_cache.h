...
int32_t fz_render_glyph_pixmap(int32_t _ctx, int32_t font, int32_t gid, const Matrix * ctm, const IRect * scissor, int32_t aa);
void fz_render_t3_glyph_direct(int32_t _ctx, int32_t _dev, int32_t _font, int32_t _gid, Matrix _trm, void * _gstate, int32_t _def_cs, void * _fill_gstate, void * _stroke_gstate);
void fz_rendered_glyph_cache_insert(int32_t _ctx, int32_t font, int32_t gid, const Matrix * ctm, u8 subpix_x, u8 subpix_y, int32_t aa, int32_t pixmap, size_t size);
int32_t fz_rendered_glyph_cache_lookup(int32_t _ctx, int32_t font, int32_t gid, const Matrix * ctm, u8 subpix_x, u8 subpix_y, int32_t aa);
size_t fz_rendered_glyph_cache_purge_font(int32_t _ctx, int32_t font);
int32_t fz_rendered_glyph_cache_remove(int32_t _ctx, int32_t font, int32_t gid, const Matrix * ctm, u8 subpix_x, u8 subpix_y, int32_t aa);
