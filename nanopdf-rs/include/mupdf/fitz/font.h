...
int32_t fz_encode_character_with_fallback(int32_t _ctx, int32_t font, int32_t unicode, int32_t _script, int32_t _language, Handle * out_font);
...
void fz_font_name(int32_t _ctx, int32_t font, char * buf, int32_t size);
void fz_glyph_name(int32_t _ctx, int32_t _font, int32_t glyph, char * buf, int32_t size);
...
int32_t fz_new_font_from_memory(int32_t _ctx, const char * name, const u8 * data, int32_t len, int32_t index, int32_t _use_glyph_bbox);
