...
function findLibrary(): string {
  const possiblePaths = [
    ...
    join(__dirname, "../../../nanopdf-rs/target/release", `${LIBRARY_PREFIX}nanopdf${LIBRARY_EXTENSION}`),
    join(__dirname, "../../../nanopdf-rs/target/debug", `${LIBRARY_PREFIX}nanopdf${LIBRARY_EXTENSION}`),
    // System paths
