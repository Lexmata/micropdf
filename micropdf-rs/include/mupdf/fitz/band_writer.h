...
const u8 * fz_band_writer_get_output(int32_t _ctx, int32_t writer, size_t * size);
...
void fz_band_writer_set_progress(int32_t _ctx, int32_t writer, ProgressCallback callback, void * user_data);
...
int32_t fz_band_writer_write_band(int32_t _ctx, int32_t writer, int32_t band_rows, const u8 * data);
