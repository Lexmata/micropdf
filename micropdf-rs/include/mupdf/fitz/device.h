...
void fz_begin_mask(int32_t _ctx, int32_t dev, fz_rect area, int32_t luminosity, int32_t colorspace, const float * color);
...
void fz_fill_image_mask(int32_t _ctx, int32_t dev, int32_t image, fz_matrix transform, int32_t colorspace, const float * color, float alpha);
void fz_fill_path(int32_t _ctx, int32_t dev, int32_t path, int32_t even_odd, fz_matrix transform, int32_t colorspace, const float * color, float alpha);
void fz_fill_text(int32_t _ctx, int32_t dev, int32_t text, fz_matrix transform, int32_t colorspace, const float * color, float alpha);
...
void fz_stroke_path(int32_t _ctx, int32_t dev, int32_t path, int32_t stroke, fz_matrix transform, int32_t colorspace, const float * color, float alpha);
void fz_stroke_text(int32_t _ctx, int32_t dev, int32_t text, int32_t stroke, fz_matrix transform, int32_t colorspace, const float * color, float alpha);
