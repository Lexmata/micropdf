...
const u8 * fz_filter_data(int32_t _ctx, int32_t filter);
...
int32_t fz_open_aesd(int32_t _ctx, int32_t chain, const u8 * key, uint32_t keylen);
int32_t fz_open_ahxd(int32_t _ctx, int32_t chain);
int32_t fz_open_arc4(int32_t _ctx, int32_t chain, const u8 * key, uint32_t keylen);
...
int32_t fz_open_range_filter(int32_t _ctx, int32_t chain, const FzRange * ranges, int32_t nranges);
