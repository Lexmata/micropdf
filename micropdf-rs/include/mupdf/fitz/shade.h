...
int32_t fz_new_function_shade(int32_t _ctx, uint64_t colorspace, const float * domain, const float * matrix);
...
int32_t fz_shade_add_color_stop(int32_t _ctx, int32_t shade, float offset, const float * color, int32_t n);
int32_t fz_shade_add_patch(int32_t _ctx, int32_t shade, const ShadePoint * points, const [f32; 4] * colors);
int32_t fz_shade_add_vertex(int32_t _ctx, int32_t shade, float x, float y, const float * color, int32_t n);
...
void fz_shade_set_background(int32_t _ctx, int32_t shade, const float * color);
