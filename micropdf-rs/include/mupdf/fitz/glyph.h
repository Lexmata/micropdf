...
int32_t fz_new_glyph_with_matrix(int32_t _ctx, int32_t font, uint32_t glyph_id, const float * matrix);
...
void fz_set_glyph_matrix(int32_t _ctx, int32_t glyph, const float * matrix);
