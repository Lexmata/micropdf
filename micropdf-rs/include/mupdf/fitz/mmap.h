...
int64_t fz_mapped_file_find(int32_t _ctx, int32_t file, const u8 * needle, size_t needle_len);
int fz_mapped_file_read(int32_t _ctx, int32_t file, size_t offset, u8 * dst, size_t len);
int64_t fz_mapped_file_rfind(int32_t _ctx, int32_t file, const u8 * needle, size_t needle_len);
