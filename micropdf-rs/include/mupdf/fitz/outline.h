...
int32_t fz_outline_iterator_insert(int32_t _ctx, int32_t iter, const FzOutlineItem * item);
const FzOutlineItem * fz_outline_iterator_item(int32_t _ctx, int32_t iter);
...
void fz_outline_iterator_update(int32_t _ctx, int32_t iter, const FzOutlineItem * item);
