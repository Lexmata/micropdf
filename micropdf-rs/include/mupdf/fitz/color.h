...
void fz_convert_color_with_params(int32_t _ctx, int32_t src_cs, const float * src, int32_t dst_cs, float * dst, int32_t proof_cs, ColorParams _params);
...
int32_t fz_new_cal_gray_colorspace(int32_t _ctx, const float * wp, const float * bp, float gamma);
int32_t fz_new_cal_rgb_colorspace(int32_t _ctx, const float * wp, const float * bp, const float * gamma, const float * matrix);
