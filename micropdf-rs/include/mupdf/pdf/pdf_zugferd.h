...
int32_t pdf_zugferd_embed(int32_t _ctx, int32_t zugferd, const u8 * xml, size_t xml_len, const ZugferdEmbedParams * params);
...
int32_t pdf_zugferd_set_xml(int32_t _ctx, int32_t zugferd, const u8 * xml, size_t len);
...
const u8 * pdf_zugferd_xml(int32_t _ctx, int32_t zugferd, size_t * len_out);
