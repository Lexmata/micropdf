...
int32_t pdf_js_event_result_validate(int32_t js, *mut c_char * newvalue);
...
void pdf_js_execute(int32_t js, const char * name, const char * code, *mut c_char * result);
...
void pdf_js_run_script(int32_t js, const char * name, *mut c_char * result);
