...
int32_t pdf_field_choice_label(int32_t _ctx, int32_t field, int32_t index, char * buf, int32_t size);
int32_t pdf_field_choice_value(int32_t _ctx, int32_t field, int32_t index, char * buf, int32_t size);
...
int32_t pdf_field_name(int32_t _ctx, int32_t field, char * buf, int32_t size);
...
int32_t pdf_field_value(int32_t _ctx, int32_t field, char * buf, int32_t size);
...
void pdf_set_field_border_color(int32_t _ctx, int32_t field, const float * color);
