...
void pdf_clean_file(int32_t _ctx, const char * infile, const char * outfile, const char * _password, const CleanOptions * _opts, int32_t _retainlen, const *const c_char * _retainlist);
...
char * pdf_format_write_options(int32_t _ctx, char * buffer, size_t buffer_len, const WriteOptions * opts);
...
void pdf_rearrange_pages(int32_t _ctx, int32_t _doc, int32_t count, const int32_t * pages, CleanStructureOption _structure);
...
void pdf_save_document(int32_t _ctx, int32_t _doc, const char * filename, const WriteOptions * _opts);
...
void pdf_vectorize_pages(int32_t _ctx, int32_t _doc, int32_t _count, const int32_t * _pages, CleanVectorizeOption _vectorize);
void pdf_write_document(int32_t _ctx, int32_t _doc, int32_t _out, const WriteOptions * _opts);
