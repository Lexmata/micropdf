...
int32_t pdf_portfolio_add_file(int32_t _ctx, int32_t portfolio, const char * name, const u8 * data, size_t len, const char * mime_type);
...
const u8 * pdf_portfolio_get_file(int32_t _ctx, int32_t portfolio, const char * name, size_t * len_out);
