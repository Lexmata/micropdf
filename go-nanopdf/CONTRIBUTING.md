# Contributing to NanoPDF Go Bindings

Thank you for your interest in contributing to NanoPDF! This document provides guidelines and instructions for contributing to the Go bindings.
...
mkdir -p ../go-nanopdf/lib/$(uname -s | tr '[:upper:]' '[:lower:]')_$(uname -m)
cp target/release/libnanopdf.a ../go-nanopdf/lib/*/
...
export CGO_LDFLAGS="-L/path/to/lib -lnanopdf"
go build
```
