...
func TestNanoPDFError_Error(t *testing.T) {
...
func TestNanoPDFError_Unwrap(t *testing.T) {
	t.Run("WithCause", func(t *testing.T) {
...
func TestNanoPDFError_Is(t *testing.T) {
	...
	t.Run("NotNanoPDFError", func(t *testing.T) {
		err1 := NewError(ErrCodeFormat, "format error")
		err2 := errors.New("standard error")

		if err1.Is(err2) {
			t.Error("NanoPDFError should not match standard error")
		}
	})
}
