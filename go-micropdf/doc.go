// Package micropdf provides Go bindings for the MicroPDF PDF manipulation library.
//
// MicroPDF is a high-performance PDF processing library built on top of MuPDF,
...
// # Memory Management
//
// MicroPDF uses manual memory management for C resources. Always call Drop()
...
// # CGO vs Mock Mode
//
// By default, MicroPDF uses CGO to call native C/Rust functions for maximum
...
//	    } else if errors.Is(err, micropdf.ErrNotFound) {
//	        // Handle not found
//	    } else {
//	        // Handle other errors
//	    }
...
//
// For detailed API documentation, see: https://pkg.go.dev/github.com/lexmata/micropdf/go-micropdf
package micropdf
