# VSCode Configuration for go-micropdf

This directory contains VSCode-specific settings for the go-micropdf project.
...
- **`cgo`**: Uses the actual Rust FFI via CGO (requires libmicropdf.a)
