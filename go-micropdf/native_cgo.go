...
#cgo linux,amd64 LDFLAGS: -L${SRCDIR}/lib/linux_amd64 -lmicropdf -lpthread -ldl -lm
#cgo linux,arm64 LDFLAGS: -L${SRCDIR}/lib/linux_arm64 -lmicropdf -lpthread -ldl -lm
#cgo darwin,amd64 LDFLAGS: -L${SRCDIR}/lib/darwin_amd64 -lmicropdf -framework CoreFoundation -framework Security
#cgo darwin,arm64 LDFLAGS: -L${SRCDIR}/lib/darwin_arm64 -lmicropdf -framework CoreFoundation -framework Security
#cgo windows,amd64 LDFLAGS: -L${SRCDIR}/lib/windows_amd64 -lmicropdf -lws2_32 -luserenv -lbcrypt -lntdll
...
func pixmapToBytes(ctx uintptr, pix uintptr, format string) []byte {
	// For CGO implementation, we return the raw samples
